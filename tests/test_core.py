...
from prompture import ask_for_json, clean_json_text, clean_json_text_with_ai, extract_and_jsonify
...
class TestCleanJsonTextWithAi:
    ...
    def test_clean_malformed_json_with_ai_help(self, integration_driver, default_model):
        ...
        result, _meta = clean_json_text_with_ai(integration_driver, malformed_json, model_name=default_model)
    ...
    def test_clean_already_valid_json(self, integration_driver, default_model):
        ...
        result, _meta = clean_json_text_with_ai(integration_driver, valid_json, model_name=default_model)
...
class TestModelNameParameter:
    ...
    def test_model_name_in_core_functions(self, integration_driver, default_model):
        ...
        result, _meta = clean_json_text_with_ai(integration_driver, json_text, model_name=default_model)
    ...
    def test_model_name_override_precedence(self, integration_driver):
        ...
        try:
            result = ask_for_json(integration_driver, "Test data", schema, model_name=override_model)
            assert_jsonify_response_structure(result)
