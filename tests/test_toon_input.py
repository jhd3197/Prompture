...
class TestJsonToToon:
    ...
    def test_json_to_toon_list_input(self):
        ...
        with patch("prompture.extraction.core.toon") as mock_toon:
    ...
    def test_json_to_toon_missing_dependency_error(self):
        ...
        with patch("prompture.extraction.core.toon", None):
...
class TestDataFrameToToon:
    ...
    @patch("prompture.extraction.core.toon")
    ...
    @patch("prompture.extraction.core.toon", None)
...
class TestExtractFromData:
    ...
    @patch("prompture.extraction.core.ask_for_json")
    @patch("prompture.extraction.core.toon")
    ...
    @patch("prompture.extraction.core._calculate_token_savings")
    @patch("prompture.extraction.core.get_driver_for_model")
    @patch("prompture.extraction.core.ask_for_json")
    @patch("prompture.extraction.core.toon")
...
class TestIntegration:
    ...
    def test_full_workflow_with_nested_data(self, mock_toon, mock_get_driver):
        ...
        with patch("prompture.extraction.core.ask_for_json") as mock_ask:
...
class TestRealLLMIntegration:
    ...
    def test_extract_from_data_with_real_llm(self, integration_driver, default_model):
        ...
        with patch("prompture.extraction.core.get_driver_for_model", return_value=integration_driver):
            result = extract_from_data(
                data=data,
