"""Mixedbread rerank driver.

Uses Mixedbread's ``/v1/rerank`` endpoint.  Requires ``MIXEDBREAD_API_KEY``.
"""
...
class MxbaiRerankDriver(RerankDriver):
    """Mixedbread rerank driver.

    Default model: ``mxbai-rerank-large-v1``.
    """
