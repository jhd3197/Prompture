"""
Example: Using extract_and_jsonify with Moonshot AI (Kimi).

This script demonstrates:
1. Initializing the Moonshot driver manually (ignoring AI_PROVIDER).
2. Extracting structured information from text using a JSON schema.
3. Overriding the Moonshot model per call with `model_name`.
...
Setup:
    ...
    International endpoint (default): https://api.moonshot.ai/v1
    China endpoint:                   https://api.moonshot.cn/v1
"""
...
# === FIRST EXAMPLE: Default instruction with Kimi K2 ===
print("Extracting information into JSON with default instruction...")

result = extract_and_jsonify(
    text=text,
    json_schema=json_schema,
    model_name="moonshot/kimi-k2-0905-preview",  # explicitly select model
)
...
# === SECOND EXAMPLE: Custom instruction with Kimi K2 ===
print("\n\n=== SECOND EXAMPLE - CUSTOM INSTRUCTION ===")
