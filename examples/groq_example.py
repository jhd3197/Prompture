...
3. Overriding the Groq model per call with `model_name`.
...
# === FIRST EXAMPLE: Default instruction with LLaMA 2-70B ===
print("Extracting information into JSON with default instruction...")

result = extract_and_jsonify(
    text=text,
    json_schema=json_schema,
    model_name="groq/llama2-70b-4096",  # explicitly select model
)
...
# === SECOND EXAMPLE: Custom instruction with Mixtral 8x7B ===
print("\n\n=== SECOND EXAMPLE - CUSTOM INSTRUCTION & DIFFERENT MODEL ===")
print("Extracting information with custom instruction using Mixtral 8x7B...")
