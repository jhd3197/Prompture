"""
Example: Reasoning / thinking mode with LM Studio (DeepSeek R1).

Demonstrates how to use a reasoning model via LM Studio and access
the model's chain-of-thought through the `last_reasoning` property.

Prerequisites:
    - LM Studio running on http://127.0.0.1:1234
    - Load a DeepSeek R1 model (e.g. deepseek/deepseek-r1-0528-qwen3-8b)

Usage:
    python examples/lmstudio_reasoning_example.py
"""
...
print("=" * 60)
print("Test 1: Reasoning with DeepSeek R1 via LM Studio")
print("=" * 60)
